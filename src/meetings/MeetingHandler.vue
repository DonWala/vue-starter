<template>
	<div v-if="this.meeting.participants.indexOf(this.username) === -1" style="float:right;">
		<button class="button button-outline" @click="signUp()">Zapisz siê</button>
		<button v-if="this.meeting.participants.length === 0" style="margin-left:5px;" @click="deleteMeeting()">Usuñ puste spotkanie</button>
	</div>
	<div v-else style="float:right;">
		<button class="button button-outline" @click="signOff()">Wypisz siê</button>
	</div>
</template>
<script>
    export default {
